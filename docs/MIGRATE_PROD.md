...
- When the production Docker image is being built, files from the bot's folder are now _copied_ rather than linked. This means that if you make changes to the files, you need to rebuild the services to see the changes.
